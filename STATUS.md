...
### S1~S2 (DE 단계, 선행 작성)
- DE35-1 미서기이중창 표준 BOM 구조 정의서 **v1.5-r2** — md (2026-04-16, BOM-RULE-UI 스펙 (v1-r1, 2026-04-16, archived) 반영. BOM_RULE +5컬럼, RULE_TEMPLATE·BOM_RULE_HISTORY 신설, 템플릿 컴파일 규칙. v1.5-r1 보존)
