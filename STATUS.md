...
- AN12-1-P1 요구사항정의서 Phase1 **v1.1-r3** — md (**2026-04-27 v1.1-r3 갱신** — CM 섹션 신규 FR 3건 (FR-CM-007 관리자 인증·FR-CM-008 비밀번호 정책·FR-CM-009 로그인 이력 감사). FR-CM-001 본문 수용기준 강화. CM FR 6→9, Phase 1 합계 70→**73건**. AN12-1 v1.5 md 미러 동시 갱신 (xlsx 본 보류, DEC-01 정책)). v1.1-r2 (2026-04-23) — 분산 구조. v1.1-r1 (2026-04-16) — FR-PM-025/026/027 신설
...
- DE24-1 인터페이스 설계서 **v2.0-r2** (통합본 + admin 인증 강화, 2,475+ 라인)
