...
> - 물리 DDL SOT 는 [[DE33-1_DB물리스키마_설계서_v1.3]]. 본 문서는 **논리 ER 수준**으로 DE33-1 v1.1/v1.2 의 공급망 확장(컬럼·신규 테이블·FK·인덱스)을 1:1 반영.
