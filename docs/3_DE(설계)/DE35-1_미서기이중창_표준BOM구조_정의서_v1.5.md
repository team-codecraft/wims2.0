...
| v1.5-r2 | 2026-04-16 | 코드크래프트 | [[2026-04-16-bom-rule-ui-design]] 반영. §6.5.2 `BOM_RULE` +5컬럼(template_id·template_instance_id·slot_values·scope_type·estimate_id), §6.5.3 `RULE_TEMPLATE` 신설 + 빌트인 6종, §6.5.4 `BOM_RULE_HISTORY` 신설, §6.5.5 템플릿 컴파일 규칙. §8.2 인덱스 +3. 참조: 용어사전 v1.4 §13 |
