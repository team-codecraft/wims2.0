---
title: DE32-1 BOM 도메인 통합 ER 다이어그램 정의서 v1.1
version: 1.1
created: 2026-04-16
updated: 2026-04-16
type: 설계
...
# DE32-1 BOM 도메인 통합 ER 다이어그램 정의서 v1.1
...
### 2.17 DIES_BOOK — 다이스북 (신규, v1.3 §14)
...
### 2.18 DIES_SUPPLIER — 금형사 (신규, v1.3 §14)
...
### 2.19 ITEM_SUPPLIER — 자재↔공급사 매핑 (신규, v1.3 §14)
...
| **v1.1** | **2026-04-16** | [[2026-04-16-bom-rule-ui-design]] 반영. §2.12 BOM_RULE +5컬럼, §2.14 RULE_TEMPLATE 신설, §2.15 BOM_RULE_HISTORY 신설, 후속 섹션 번호 +2 재정렬 (RESOLVED_BOM→2.16, DIES_BOOK→2.17, DIES_SUPPLIER→2.18, ITEM_SUPPLIER→2.19), erDiagram 엔티티·관계 2종 추가 |
