...
│                                                           │
│ ─ 자연어 미리보기 ────────────────────────────────────────  │
│ "225 미서기·W3XH2-3편·W≥3000mm 일 때 보강재 1개와 보강공정을│
│  추가합니다"                                               │
│                                                           │
│ ─ 원시 조건식 (토글) ─────────────────────────────────────  │
│ productClassPath = '미서기/마스/복층/225' AND             │
│   OPT-LAY IN ('W3XH2-3편') AND W >= 3000                  │
│                                                           │
│ [시뮬레이션 먼저 실행] [저장]                              │
└──────────────────────────────────────────────────────────┘
```
...
├────────────────────────────┼────────┼────────┼────────┼──────────┼─────────────────┼─────────┤
│ 🔩 치수초과보강재 #12       │W3XH2-3편│   *    │   *    │ W≥3000   │+보강재×2,+공정   │  100    │
├── ⚠ 충돌: #15 와 겹침 ──────┴────────┴────────┴────────┴──────────┴─────────────────┴─────────┤
...
| 버전 | 날짜 | 내용 |
|------|------|------|
| v1.5 | 2026-04-15 | 초기 작성. NUMERIC 옵션 치수 입력 서브탭 신설, action 카드 UI, 확정구성표 컬럼 확장 |
