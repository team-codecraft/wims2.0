...
| 9 | BOM 버전 추적 불가 (설계 변경 시 기존 주문과 신규 주문의 BOM 혼선) | 주문 생성 시 Resolved BOM 불변 스냅샷(`resolvedBomId`, `standardBomId + standardBomVersion` 고정) 을 주문에 바인딩, 설계 변경은 ECO 프로세스로만 반영 | [[DE35-1_미서기이중창_표준BOM구조_정의서_v1.6\|DE35-1]] §6.2, [[DE24-1_인터페이스설계서_v2.0\|DE24-1]] §5.4 |
